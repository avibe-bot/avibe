...
>
> Product contract: `docs/plans/memory-plugin-everos-phase1.md`
>
> Provider decision: `docs/plans/memory-plugin-product-research.md`
...
Run `docs/plans/memory-poc-everos.md`. Select official EverOS, a small fork, or
