...
latest gate-complete rerun (r31) exercised all eight cases after the current-head
...
parallel case had reasoning absent, failed both parse gates, and failed final
system marker, system scope, and exact tuple.
