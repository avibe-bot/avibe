...
>
> Related documents:
> - Product scope: `docs/plans/memory-plugin-everos-phase1.md`
> - Provider POC: `docs/plans/memory-poc-everos.md`
...
`docs/plans/memory-poc-everos.md` section 6 so thresholds cannot drift between
documents.
