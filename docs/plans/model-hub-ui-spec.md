...
- Forms A, B and C are selected from a **non-terminal** returned `presentation`, never a
  ...
  `migration_item_conflict` stops immediately; R5/G-34 holds its error-envelope consumer
  pending K4 rather than guessing;
