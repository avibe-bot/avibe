...
| RS-8 — non-guard failure / no answer | `direct_mode`, another shaped rejection, or no response evidence | `direct_mode` immediately retires the now-illegal editor into Direct. Another shaped rejection enters Route save rejected. No answer enters Route save outcome unknown and MUST reconcile before any resend |
