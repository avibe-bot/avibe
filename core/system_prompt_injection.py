...
- The Markdown handler is page-owned and receives no visitor identity, Avibe Session/Project/Organization context, cookies, Authorization, CSRF credentials, or caller-supplied Show Runtime protocol headers. Public `/p/<share_id>/` Markdown is public data, so never include secrets or private information in it.
