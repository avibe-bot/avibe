...
PROMPT_MODULES: tuple[PromptModule, ...] = (
    ...
    PromptModule("show-pages-prompt", "Show Pages Prompt", "show-pages.md", leading_newlines=1, trailing_newlines=1, placeholders=("skill_routing",)),
    PromptModule("show-pages-skill-routing", "Show Pages Skill routing", "show-pages-skill-routing.md"),
    PromptModule("vault-routing-prompt", "Vault Routing Prompt", "vault.md", leading_newlines=1, trailing_newlines=1),
    PromptModule("harness-routing-prompt", "Harness Routing Prompt", "harness.md", leading_newlines=1, trailing_newlines=1, placeholders=("skill_routing", "tool_policy_section", "enabled_agents_table")),
    PromptModule("harness-skill-routing", "Harness Skill routing", "harness-skill-routing.md"),
    ...
    PromptModule("user-preferences-memory-admitted-routing", "User Preferences Memory Admitted Routing", "user-preferences-memory-routing.md"),
    PromptModule("user-preferences-passive-usage", "User Preferences Passive Usage", "user-preferences-passive-usage.md"),
    PromptModule("user-preferences-memory-admitted-usage", "User Preferences Memory Admitted Usage", "user-preferences-memory-usage.md"),
    PromptModule("user-preferences-passive-update-guidance", "User Preferences Passive Update Guidance", "user-preferences-passive-update.md"),
    PromptModule("user-preferences-memory-admitted-update-guidance", "User Preferences Memory Admitted Update Guidance", "user-preferences-memory-update.md"),
    PromptModule("memory-cli-prompt", "Memory Cli Prompt", "memory-cli.md", leading_newlines=1, trailing_newlines=1),
