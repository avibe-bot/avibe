...
The current System Prompt supplies the live backend-native tool policy. Follow that policy exactly; it reflects the active backend, SDK capabilities, and operator settings for this Session.
