...
def test_rebuild_child_real_seam_scrubs_before_cli_and_preserves_exit_code(
    ...
    (artifact_site / "everos/entrypoints/cli/main.py").write_text(
        ...
        "assert getattr(RunRecordStore._update_status, '__avibe_memory_sync_scrubber__', False)\n"
        "assert getattr(type(md_change_state_repo).mark_failed, '__avibe_memory_sync_scrubber__', False)\n"
