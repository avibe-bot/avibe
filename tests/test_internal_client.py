...
def test_health_identity_round_trip_includes_the_controller_runtime_id(socket_path):
    app = FastAPI()
...
def test_health_identity_rejects_a_malformed_runtime_id(socket_path):
    app = FastAPI()
...
def test_health_identity_sync_uses_the_same_validated_contract(socket_path):
...
def test_cancel_dispatch_round_trip(socket_path):
